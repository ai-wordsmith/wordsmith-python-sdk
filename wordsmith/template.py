...
class Template(object):
    ...
    :param project_slug: String representing the slug of the parent project of
                         this template
    :param template_data: Dictionary representation of the template data for a
                          single project in the project list JSON response from
                          Wordsmith.
    :param config: wordsmith.Configuration object containing configuration
                   details
    """
    ...
    def generate_narrative(self, data):
        ...
        :param data: Dictionary of key, value pairs where the value represents
                     the Wordsmith column name and the value represents the
    ...
    def batch_narrative(self, data_list):
        ...
        :param data_list: List of dictionaries where key, value pairs represent
                          the Wordsmith column name and column value
                          respectively
        :param pool_size: (optional) Int representing the number of workers to
