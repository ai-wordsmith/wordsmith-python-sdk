...
class Narrative(object):
    ...
    :param project_slug: String representing the slug of the parent project of
                         this narrative
    :param template_slug: String representing the slug of the parent template
                          of this narrative
    :param data: Dictionary representation of the row data to be passed to the
                 Wordsmith platform
    ...
    def __init__(self, project_slug, template_slug, data, config):
        ...
        self.data = data
        self._config = config
        self.post_url = '{}/projects/{}/templates/{}/outputs'\
                        .format(self._config.base_url,
                                self.project_slug,
                                self.template_slug)
...
class Batch(object):
    ...
    :param template_slug: String representing the slug of the parent template
                          of this narrative
    :param data_list: List of dictionary representations of the row data to be
                      passed to the Wordsmith platform
    :param config: wordsmith.Configuration object containing configuration
                   details
    """
    ...
    def _generate_narrative(self, data):
        narrative = None
        try:
            narrative = Narrative(self.project_slug,
                                  self.template_slug,
                                  data,
                                  self._config)
    ...
    def generate(self):
        ...
        self.narratives = thread_pool.map(self._generate_narrative,
                                          self.data_list)
        thread_pool.close()
        thread_pool.join()
